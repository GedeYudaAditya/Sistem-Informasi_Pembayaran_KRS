            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('nim') ? 'is-invalid' : NULL; ?>" id="nim" name="nim" maxlength="10" value="<?= $mahasiswa['nim']; ?>" readonly>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('nama') ? 'is-invalid' : NULL; ?>" id="nama" name="nama" value="<?= $mahasiswa['nama']; ?>">
                        <div class="invalid-feedback">
                            <?= form_error('nama'); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select form-control <?= form_error('prodi') ? 'is-invalid' : NULL; ?>" id="prodi" name="prodi" type="text">
                            ...
                            <?php foreach ($prodis as $pr) : ?>
                                <option value="<?= $pr['id']; ?>" <?= $pr['id'] == $mahasiswa['prodi'] ? 'selected' : NULL; ?>><?= $pr['prodi']; ?></option>
                            <?php endforeach; ?>
                        </select>
                        <div class="invalid-feedback">
                            <?= form_error('prodi'); ?>
                ...
                <div class="col-lg">
                    <div class="form-group">
                        ...
                        <select class="custom-select form-control <?= form_error('angkatan') ? 'is-invalid' : NULL; ?>" id="angkatan" name="angkatan" type="text">
                            ...
                            <?php foreach ($th as $t) : ?>
                                <option value="<?= $t; ?>" <?= $t == $mahasiswa['angkatan'] ? 'selected' : NULL; ?>><?= $t; ?></option>
                            <?php endforeach; ?>
                        </select>
                        <div class="invalid-feedback">
                            <?= form_error('angkatan'); ?>
            ...
            <div class="row d-flex justify-content-space-between">
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select form-control <?= form_error('smtr') ? 'is-invalid' : NULL; ?>" id="smtr" name="smtr">
                            ...
                            <?php foreach ($semester as $smtr) : ?>
                                <option value="<?= $smtr; ?>" <?= $smtr == $mahasiswa['semester'] ? 'selected' : NULL; ?>><?= $smtr; ?></option>
                            <?php endforeach ?>
                        </select>
                        <div class="invalid-feedback">
                            <?= form_error('smtr'); ?>
                ...
                <div class="col-lg">
                    <div class="form-group">
                        ...
                        <select class="custom-select form-control <?= form_error('dosen_pa') ? 'is-invalid' : NULL; ?>" id="dosen_pa" name="dosen_pa" readonly>
                            <option value="">-- Pilih Dosen PA --</option> -->
                            <?php foreach ($dosen as $dsn) : ?>
                                <option value="<?= $dsn['id']; ?>" <?= $dsn['id'] == $mahasiswa['pa_id'] ? 'selected' : NULL; ?>><?= $dsn['nama']; ?></option>
                            <?php endforeach ?>
                        </select>
                        <div class="invalid-feedback">
                            <?= form_error('dosen_pa'); ?>
