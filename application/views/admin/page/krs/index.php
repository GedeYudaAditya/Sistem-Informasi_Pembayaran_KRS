 ...
 <div class="container-fluid">
     ...
     <div class="accordion" id="ManajemenInteger">
         <div class="card shadow mb-4">
             ...
             <a href="#kegiatan" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="kegiatan">
             ...
             <div class="collapse" id="kegiatan" data-parent="#ManajemenInteger">
                 <div class="card-body">
                     <a href="<?= base_url() ?>integer/tambah_kegiatan" class="btn btn-primary btn-sm btn-icon-split mb-4">
                             ...
                             <tbody>
                                 <?php foreach ($integer as $data) : ?>
                                     <tr>
                                         ...
                                         <td><img src="<?= base_url() ?>assets/upload/Folder_integer_website/foto/<?= $data['logo_integer']; ?>" alt="" class="lazyload" data-src="<?= base_url() ?>assets/upload/Folder_integer_website/foto/<?= $data['logo_integer']; ?>" width="150px" style="background-color: #eaeaea;"></td>
                                         <td><a href="<?= base_url() ?>assets/upload/Folder_integer_website/video/<?= $data['video_integer']; ?>" class="btn btn-primary btn-sm btn-icon-split">
                                                 <span class="icon text-white-50">
                                         ...
                                         <td><a href="<?= base_url() ?>integer/download_file_informasi_integer/<?= $data['panduan_integer'] ?>/file_informasi" class="btn btn-info btn-sm btn-icon-split">
                                                 <span class="icon text-white-50">
                                         ...
                                         <?php if ($group[0]['group_id'] == "1") { ?>
                                             <td>
                                                 <a href="<?= base_url() ?>integer/hapus_data_integer/<?= $data['id_integer']; ?>" class="btn btn-danger btn-sm btn-icon-split tombol-hapus">
                                                     <span class="icon text-white-50">
         ...
         <?php if (!empty($active_integer)) { ?>
             <div class="card shadow mb-4">
                 <!-- Card Header - Accordion -->
                 <a href="#sponsor" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="sponsor">
                 ...
                 <div class="collapse" id="sponsor" data-parent="#ManajemenInteger">
                     <div class="card-body">
                         <a href="<?= base_url() ?>integer/tambah_sponsor" class="btn btn-primary btn-sm btn-icon-split mb-4">
                             <span class="icon text-white-50">
                                 <i class="fas fa-flag"></i>
                             </span>
                             <span class="text">Tambah Data</span>
                                 ...
                                 <tbody>
                                     <?php foreach ($sponsor as $data) : ?>
                                         <tr>
                                             ...
                                             <td style="text-align: center;"> <img src="<?= base_url() ?>assets/upload/Folder_integer_website/sponsor/<?= $data['foto_sponsor_integer']; ?>" alt="" width="50px" class="lazyload" data-src="<?= base_url() ?>assets/upload/Folder_integer_website/sponsor/<?= $data['foto_sponsor_integer']; ?>">
                                             </td>
                                             <td><?= $data['create_by']; ?></td>
                                             <td><?= $data['create_at']; ?></td>
                                             <td> <?php if ($group[0]['group_id'] == "1" || $group[0]['group_id'] == "2") { ?>
                                                     <a href="<?= base_url() ?>integer/hapus_data_sponsor_integer/<?= $data['id_sponsor_integer']; ?>" class="btn btn-danger btn-sm btn-icon-split tombol-hapus">
                                                         <span class="icon text-white-50">
                                                             <i class="fas fa-trash"></i>
                                                         </span>
                                                         <span class="text">Delete</span>
             ...
             <div class="card shadow mb-4">
                 <!-- Card Header - Accordion -->
                 <a href="#jadwal" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="jadwal">
                 ...
                 <div class="collapse" id="jadwal" data-parent="#ManajemenInteger">
                     <div class="card-body">
                         ...
                         <a href="<?= base_url() ?>integer/tambah_tanggal" class="btn btn-primary btn-sm btn-icon-split mb-4">
                             <span class="icon text-white-50">
                                 <i class="fas fa-flag"></i>
                             </span>
                             <span class="text">Tambah Data</span>
                                 ...
                                 <tbody>
                                     <?php foreach ($hari as $data) : ?>
                                         <tr>
                                             ...
                                             <?php if ($group[0]['group_id'] == "1") { ?>
                                                 <td>
                                                     <a href="<?= base_url() ?>integer/hapus_data_hari_integer/<?= $data['id_hari_integer']; ?>" class="btn btn-danger btn-sm btn-icon-split tombol-hapus">
                                                         <span class="icon text-white-50">
                                                             <i class="fas fa-trash"></i>
                                                         </span>
                                                         <span class="text">Delete</span>
                         ...
                         <!-- Kegiatan Perhari -->
                         <a href="<?= base_url() ?>integer/tambah_kegiatan_perhari" class="btn btn-primary btn-sm btn-icon-split mb-4 mt-4">
                             <span class="icon text-white-50">
                                 <i class="fas fa-flag"></i>
                             </span>
                             <span class="text">Tambah Data</span>
                                 ...
                                 <tbody>
                                     <?php foreach ($detail_hari as $data) : ?>
                                         <tr>
                                             ...
                                             <td><?= $data['create_at']; ?></td>
                                             <td> <?php if ($group[0]['group_id'] == "1" || $group[0]['group_id'] == "2") { ?>
                                                     <a href="<?= base_url() ?>integer/hapus_data_detail_hari_integer/<?= $data['id_detail_hari_integer']; ?>" class="btn btn-danger btn-sm btn-icon-split tombol-hapus">
                                                         <span class="icon text-white-50">
                                                             <i class="fas fa-trash"></i>
                                                         </span>
                                                         <span class="text">Delete</span>
