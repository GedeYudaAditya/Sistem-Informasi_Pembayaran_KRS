				...
				<div id="wrapper">
					...
					<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
						...
						<?php if ($group[0]['group_id'] == "9") { ?>
							...
							<!-- Nav Item - Pages Collapse Menu -->
							<li class="nav-item">
								<a class="nav-link" href="<?= base_url() ?>/krs/listMahasiswa">
									<i class="fas fa-hotel"></i>
									<i><span class="text-warning">Data Mahasiswa</span></i>
								</a>
							</li>
						<?php } ?>

						<!-- Menu Untuk User Mahasiswa [Bendahara - HMJ] Sistem KRS -->
							...
							<li class="nav-item">
								...
								<div id="collapseMahasiswa" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
									<div class="bg-white py-2 collapse-inner rounded">
										...
										<?php endif; ?>
										<a class="collapse-item" href="<?= base_url() ?>krs/minta_bukti">Daftar Iuran</a>
										<!-- <a class="collapse-item" href="<?= base_url() ?>">Validasi</a> -->
									</div>
								</div>
							</li>
						<?php } ?>
								...
								<ul class="navbar-nav ml-auto">
									...
									<li class="nav-item dropdown no-arrow">
										<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
											<span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= ucfirst($group[0]['first_name']); ?></span>
