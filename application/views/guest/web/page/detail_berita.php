                        ...
                        <div id="carouselExampleInterval" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item active" data-interval="2000" data-touch="true">
                                    <img data-src="<?= base_url() ?>assets/upload/Folder_informasi/foto/<?= $detail[0]['foto1_informasi']; ?>"
                                        src="<?= base_url() ?>assets/upload/Folder_informasi/foto/<?= $detail[0]['foto1_informasi']; ?>"
                            ...
                            <div class="single-accordion blog-accordion">
                                <h5>
                                    <a role="button" class="collapse show text-uppercase d-block p-3"
                                        data-toggle="collapse" href="#accordion1">Kategori
                                    </a>
                                </h5>
                                ...
                                <div id="accordion1" class="accordion-content widget-content collapse
                                    ...
                                    <ul class="widget-items">
                                        <li><a href="<?= base_url() ?>web/berita"
                                                class="d-flex p-3"><span>Berita</span><span
                                                    class="ml-auto">(<?= $berita ?>)</span></a></li>
                                        <li><a href="<?= base_url() ?>web/berita" class="d-flex p-3"><span>Karya
                                                    Tulis</span><span class="ml-auto">(<?= $redaksi ?>)</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <ul class="widget-items">
                                        ...
                                        <li>
                                            <a href="<?= base_url() ?>web/detail_berita/<?= $data['id_informasi'] ?>"
                                                class="single-post align-items-center
